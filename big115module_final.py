...
def excel_read_result(maindata):
    ...
    file = "C:\\Users\\L.Amirova\\Documents\\result\\result.xls" #L.Amirova / L.Amirova
    ...
    for i in range(len(xl['Участник'])):
        ...
        if UF_type == "F":
            adressname = "Y:\\08 ПОДФТ\\анкеты\\ФЛ"
        else:
            adressname = "Y:\\08 ПОДФТ\\анкеты\\ЮЛ"
        ...
        print(adressname)
        print(adressname + "\\" + nameclient + "\\table1.docx" + "\n")
        ...
        print(adressname + "\\" + nameclient + "\\table2.docx" + "\n")
        ...
        if newcolor == lastcolor:
            while newcolor == lastcolor:
                newcolor = random.randint(0, 6)
        mycolor(newcolor)
        print("[" + UF_type + "] " + my_txt(str_xl).rstrip(" ") + " : обработан\n")
        print("-" * 55 + "\n")
        print(Style.RESET_ALL, end="")
    print(Fore.BLUE + "\n" + "=" * 55 + "\n")
    print(Style.RESET_ALL, end="")
