...
df = pd.read_csv('C:\\files\\ALL_corpbonds_screener_700D.csv', delimiter=';')
...
plt.legend(title='годовая динамика котировок корп.облигаций')
...
plt.savefig('C:\\files\\pctrs\\ALL_1Y_' + filename + '.png')
plt.savefig('C:\\files\\pctrs\\ALL_1Y_DAY.png')
