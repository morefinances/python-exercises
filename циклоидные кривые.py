...
hs = StringVar(value=15)
h_entry = Spinbox(from_=1.0, to=100.0, textvariable=hs)
...
txt=Text(width=48, height=4, wrap=WORD, font=("Courier New", 10)) # текст, вернуться позже
txt.place(x = 30, y = 550)
txt.insert(1.0,'Эпициклоида — плоская кривая, образуемая фиксированной точкой окружности, катящейся по внешней стороне другой окружности без скольжения. ')
